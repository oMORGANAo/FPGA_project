...
#set_property -dict { PACKAGE_PIN R14   IOSTANDARD LVCMOS33 } [get_ports { oLEDSW1 }]; #IO_L6N_T0_VREF_34 Sch=led[0]
#set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { oLEDSW0 }]; #IO_L6P_T0_34 Sch=led[1]
...
set_property -dict { PACKAGE_PIN L19   IOSTANDARD LVCMOS33 } [get_ports { iFunc }]; #IO_L9P_T1_DQS_AD3P_35 Sch=btn[3]
