...
# module references:
# AsciiCharsMem, Debounce_Switch, Debounce_Switch, Debounce_Switch, Debounce_Switch, Debounce_Switch, ScreenBufferMem, VGA_pattern, VGA_timings, num_capture_4bit
...
proc create_root_design { parentCell } {
  ...
  set iFunc [ create_bd_port -dir I iFunc ]
  ...
  connect_bd_net -net Debounce_Switch_2_o_Switch [get_bd_pins Debounce_Switch_2/o_Switch] [get_bd_pins num_capture_4bit_0/iFunc]
  connect_bd_net -net Debounce_Switch_3_o_Switch [get_bd_pins Debounce_Switch_3/o_Switch] [get_bd_pins num_capture_4bit_0/iSW1]
  connect_bd_net -net Debounce_Switch_4_o_Switch [get_bd_pins Debounce_Switch_4/o_Switch] [get_bd_pins VGA_pattern_0/iSW0] [get_bd_pins num_capture_4bit_0/iSW0]
  ...
  connect_bd_net -net clk_in1_0_1 [get_bd_ports iClk] [get_bd_pins Debounce_Switch_0/i_Clk] [get_bd_pins Debounce_Switch_1/i_Clk] [get_bd_pins Debounce_Switch_2/i_Clk] [get_bd_pins Debounce_Switch_3/i_Clk] [get_bd_pins Debounce_Switch_4/i_Clk] [get_bd_pins clk_wiz_0/clk_in1]
  ...
  connect_bd_net -net i_Switch_0_1 [get_bd_ports iStop] [get_bd_pins Debounce_Switch_1/i_Switch]
  connect_bd_net -net i_Switch_0_2 [get_bd_ports iPush] [get_bd_pins Debounce_Switch_0/i_Switch]
  connect_bd_net -net i_Switch_0_3 [get_bd_ports iFunc] [get_bd_pins Debounce_Switch_2/i_Switch]
  connect_bd_net -net i_Switch_0_4 [get_bd_ports iSW1] [get_bd_pins Debounce_Switch_3/i_Switch]
  connect_bd_net -net i_Switch_0_5 [get_bd_ports iSW0] [get_bd_pins Debounce_Switch_4/i_Switch]
